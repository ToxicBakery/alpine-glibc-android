...
RUN apk --no-cache add bash wget gnupg openjdk17 unzip git curl python3 bzip2 openssh-client py3-pip \
...
# SDK
 && wget -q -O android-sdk.zip https://dl.google.com/android/repository/platform-tools-latest-linux.zip \
 && mkdir ${ANDROID_HOME} \
